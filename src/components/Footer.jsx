      ...
      <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
        ...
        <div>
          ...
          <ul className="font-medium text-gray-500 dark:text-gray-400">
			{data.anchorInfo.map((d,i)=>(
				i=== 0?<li className="mb-4">
              <a href={d.ref} className="hover:underline">{d.name}</a>
            </li>:
				
            
            <li>
              <a href={d.ref} className="hover:underline"
                >{d.name}</a
              >
            </li>
			))}
