...
const featureData = [
    {
      heading:'Marketing',
      description:`Plan it, create it, launch it. Collaborate seamlessly with all the
   ...
   {
      heading:'Legal',
      description:`Protect your organization, devices and stay compliant with our
   ...
   },
    {
      ...
      description:`Auto-assign tasks, send Slack messages, and much more. Now power up
     ...
     {
      heading:'Finance',
      description:`Audit-proof software built for critical financial operations like
   ...
   },
    {
      ...
      description:`Craft beautiful, delightful experiences for both marketing and product
            with real cross-company collaboration.`,
      d:'M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z'
   },
    {
      heading:'Operations',
      description:`Keep your company’s lights on with customizable, iterative, and
